...
class UpdateVehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'registration_number' => ['required', 'string', 'max:50', 'unique:vehicles,registration_number,' . $vehicleId],
            'internal_code' => ['nullable', 'string', 'max:50', 'unique:vehicles,internal_code,' . $vehicleId],
