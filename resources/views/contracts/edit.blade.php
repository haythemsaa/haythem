...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-file-contract"></i> Modifier Contrat</h2>
        <a href="{{ route('contracts.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Retour</a>
    </div>

    <div class="card">
        <div class="card-header bg-warning text-white"><h5 class="mb-0">Informations Contrat</h5></div>
        <div class="card-body">
            <form action="{{ route('contracts.update', $contract) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="contract_number" class="form-control @error('contract_number') is-invalid @enderror" value="{{ old('contract_number', $contract->contract_number) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="contract_type" class="form-select @error('contract_type') is-invalid @enderror" required>
                            ...
                            <option value="Leasing" {{ old('contract_type', $contract->contract_type) == 'Leasing' ? 'selected' : '' }}>Leasing</option>
                            <option value="Assurance" {{ old('contract_type', $contract->contract_type) == 'Assurance' ? 'selected' : '' }}>Assurance</option>
                            <option value="Service" {{ old('contract_type', $contract->contract_type) == 'Service' ? 'selected' : '' }}>Service</option>
                            <option value="Autre" {{ old('contract_type', $contract->contract_type) == 'Autre' ? 'selected' : '' }}>Autre</option>
                        </select>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="supplier_name" class="form-control @error('supplier_name') is-invalid @enderror" value="{{ old('supplier_name', $contract->supplier_name) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="vehicle_id" class="form-select @error('vehicle_id') is-invalid @enderror">
                            ...
                            <option value="{{ $vehicle->id }}" {{ old('vehicle_id', $contract->vehicle_id) == $vehicle->id ? 'selected' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" name="monthly_cost" class="form-control @error('monthly_cost') is-invalid @enderror" value="{{ old('monthly_cost', $contract->monthly_cost) }}" required>
                        @error('monthly_cost')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Coût Total (DH)</label>
                        <input type="number" step="0.01" name="total_cost" class="form-control @error('total_cost') is-invalid @enderror" value="{{ old('total_cost', $contract->total_cost) }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="auto_renewal" class="form-select @error('auto_renewal') is-invalid @enderror">
                            <option value="0" {{ old('auto_renewal', $contract->auto_renewal) == '0' ? 'selected' : '' }}>Non</option>
                            <option value="1" {{ old('auto_renewal', $contract->auto_renewal) == '1' ? 'selected' : '' }}>Oui</option>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <small class="text-muted">Fichier actuel: {{ basename($contract->contract_document) }}</small>
                        @endif
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" rows="3" class="form-control @error('description') is-invalid @enderror">{{ old('description', $contract->description) }}</textarea>
