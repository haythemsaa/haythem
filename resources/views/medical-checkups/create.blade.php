...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-heartbeat"></i> Nouvelle Visite Médicale</h2>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('medical-checkups.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('checkup_type') is-invalid @enderror"
                                ...
                                @foreach($checkupTypes as $key => $label)
                                    <option value="{{ $key }}" {{ old('checkup_type') == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('checkup_date') is-invalid @enderror"
                                   id="checkup_date" name="checkup_date" value="{{ old('checkup_date') }}" required>
                            @error('checkup_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('next_checkup_date') is-invalid @enderror"
                                   id="next_checkup_date" name="next_checkup_date" value="{{ old('next_checkup_date') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('medical_center') is-invalid @enderror"
                                   id="medical_center" name="medical_center" value="{{ old('medical_center') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('result') is-invalid @enderror"
                                ...
                                @foreach($results as $key => $label)
                                    <option value="{{ $key }}" {{ old('result') == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('restrictions') is-invalid @enderror"
                                      ...
                                      placeholder="Port de charges lourdes interdit, conduite de nuit déconseillée, etc.">{{ old('restrictions') }}</textarea>
                            @error('restrictions')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="d-flex justify-content-end mt-4">
                    <a href="{{ route('medical-checkups.index') }}" class="btn btn-secondary me-2">Annuler</a>
