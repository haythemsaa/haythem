...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header bg-warning text-white"><h5 class="mb-0">Informations Fournisseur</h5></div>
        <div class="card-body">
            <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $supplier->supplier_code }}" disabled>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="is_active" class="form-select @error('is_active') is-invalid @enderror">
                            <option value="1" {{ old('is_active', $supplier->is_active) == '1' ? 'selected' : '' }}>Actif</option>
                            <option value="0" {{ old('is_active', $supplier->is_active) == '0' ? 'selected' : '' }}>Inactif</option>
                        </select>
