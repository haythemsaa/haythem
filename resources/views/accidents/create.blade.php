        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0"><i class="fas fa-car-crash"></i> Enregistrer un Accident</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('accidents.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="accident_date" id="accident_date" class="form-control @error('accident_date') is-invalid @enderror" value="{{ old('accident_date', date('Y-m-d')) }}" required>
                                @error('accident_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="time" name="accident_time" id="accident_time" class="form-control @error('accident_time') is-invalid @enderror" value="{{ old('accident_time') }}">
                                @error('accident_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="location" id="location" rows="2" class="form-control @error('location') is-invalid @enderror" required>{{ old('location') }}</textarea>
                                @error('location')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="severity" id="severity" class="form-select @error('severity') is-invalid @enderror" required>
                                    @foreach($severities as $key => $label)
                                        <option value="{{ $key }}" {{ old('severity', 'mineure') == $key ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="injured_count" id="injured_count" class="form-control @error('injured_count') is-invalid @enderror" value="{{ old('injured_count', 0) }}" min="0">
                                @error('injured_count')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="fatalities_count" id="fatalities_count" class="form-control @error('fatalities_count') is-invalid @enderror" value="{{ old('fatalities_count', 0) }}" min="0">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="material_damage" id="material_damage" rows="3" class="form-control @error('material_damage') is-invalid @enderror">{{ old('material_damage') }}</textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="third_parties" id="third_parties" rows="3" class="form-control @error('third_parties') is-invalid @enderror">{{ old('third_parties') }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="insurance_claim_number" id="insurance_claim_number" class="form-control @error('insurance_claim_number') is-invalid @enderror" value="{{ old('insurance_claim_number') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="estimated_cost" id="estimated_cost" step="0.01" class="form-control @error('estimated_cost') is-invalid @enderror" value="{{ old('estimated_cost') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                                    @foreach($statuses as $key => $label)
                                        <option value="{{ $key }}" {{ old('status', 'en_cours') == $key ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
