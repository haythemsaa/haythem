        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0"><i class="fas fa-exclamation-circle"></i> Enregistrer une Infraction Routière</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('traffic-violations.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="location" id="location" rows="2" class="form-control @error('location') is-invalid @enderror">{{ old('location') }}</textarea>
                                @error('location')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="fine_amount" id="fine_amount" step="0.01" class="form-control @error('fine_amount') is-invalid @enderror" value="{{ old('fine_amount') }}">
                                @error('fine_amount')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="points_deducted" id="points_deducted" class="form-control @error('points_deducted') is-invalid @enderror" value="{{ old('points_deducted', 0) }}" min="0" max="30">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="additional_costs" id="additional_costs" step="0.01" class="form-control @error('additional_costs') is-invalid @enderror" value="{{ old('additional_costs') }}">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="consequences" id="consequences" rows="3" class="form-control @error('consequences') is-invalid @enderror" placeholder="Suspension de permis, immobilisation du véhicule, etc.">{{ old('consequences') }}</textarea>
                                @error('consequences')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
