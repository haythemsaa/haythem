...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-tire"></i> Modifier Pneumatique</h2>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('tires.update', $tire) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('brand') is-invalid @enderror"
                                   id="brand" name="brand" value="{{ old('brand', $tire->brand) }}" required>
                            @error('brand')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('model') is-invalid @enderror"
                                   id="model" name="model" value="{{ old('model', $tire->model) }}" required>
                            @error('model')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('size') is-invalid @enderror"
                                   id="size" name="size" value="{{ old('size', $tire->size) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('tire_type') is-invalid @enderror"
                                ...
                                @foreach($tireTypes as $key => $label)
                                    <option value="{{ $key }}" {{ old('tire_type', $tire->tire_type) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('site_id') is-invalid @enderror"
                                ...
                                @foreach($sites as $site)
                                    <option value="{{ $site->id }}" {{ old('site_id', $tire->site_id) == $site->id ? 'selected' : '' }}>
                                        {{ $site->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('vehicle_id') is-invalid @enderror"
                                ...
                                @foreach($vehicles as $vehicle)
                                    <option value="{{ $vehicle->id }}" {{ old('vehicle_id', $tire->vehicle_id) == $vehicle->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('position') is-invalid @enderror"
                                ...
                                @foreach($tirePositions as $key => $label)
                                    <option value="{{ $key }}" {{ old('position', $tire->position) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror"
                                ...
                                @foreach($tireStatuses as $key => $label)
                                    <option value="{{ $key }}" {{ old('status', $tire->status) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('purchase_date') is-invalid @enderror"
                                   ...
                                   value="{{ old('purchase_date', $tire->purchase_date?->format('Y-m-d')) }}" required>
                            @error('purchase_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('installation_date') is-invalid @enderror"
                                   ...
                                   value="{{ old('installation_date', $tire->installation_date?->format('Y-m-d')) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('purchase_cost') is-invalid @enderror"
                                   ...
                                   value="{{ old('purchase_cost', $tire->purchase_cost) }}" required>
                            @error('purchase_cost')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.1" class="form-control @error('initial_tread_depth') is-invalid @enderror"
                                   ...
                                   value="{{ old('initial_tread_depth', $tire->initial_tread_depth) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.1" class="form-control @error('current_tread_depth') is-invalid @enderror"
                                   ...
                                   value="{{ old('current_tread_depth', $tire->current_tread_depth) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('mileage_at_installation') is-invalid @enderror"
                                   ...
                                   value="{{ old('mileage_at_installation', $tire->mileage_at_installation) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('current_mileage') is-invalid @enderror"
                                   ...
                                   value="{{ old('current_mileage', $tire->current_mileage) }}">
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <h5 class="mb-3"><i class="fas fa-ban"></i> Retrait</h5>

                        <div class="mb-3">
                            <label for="removal_date" class="form-label">Date de Retrait</label>
                            <input type="date" class="form-control @error('removal_date') is-invalid @enderror"
                                   id="removal_date" name="removal_date"
                                   value="{{ old('removal_date', $tire->removal_date?->format('Y-m-d')) }}">
                            @error('removal_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="removal_reason" class="form-label">Raison du Retrait</label>
                            <input type="text" class="form-control @error('removal_reason') is-invalid @enderror"
                                   id="removal_reason" name="removal_reason"
                                   value="{{ old('removal_reason', $tire->removal_reason) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror"
                                      id="notes" name="notes" rows="4">{{ old('notes', $tire->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
